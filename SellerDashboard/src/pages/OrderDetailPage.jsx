...
const OrderDetailPage = () => {
  ...
  return (
    ...
    <div className="data w-full grid overflow-scroll no-scrollbar">
          <div className="head grid grid-cols-[48px_389px_137px_137px_137px_111px] h-[54px] items-center bg-[#00000005]">
           ...
           <div className="stock border pl-[10px] w-[137px] flex items-center border-[#0000000f] h-full" >Quantity</div>
           <div className="price border pl-[10px] w-[137px] flex items-center border-[#0000000f] h-full" >Price</div>
           <div className="price border pl-[10px] w-[137px] flex items-center border-[#0000000f] h-full" >Total</div>
           <div className="action border pl-[10px] w-[111px] flex items-center border-[#0000000f] h-full" >Action</div>
          </div>
         {order?.products?.map((product,index)=>(
            <div key={product._id} className="body grid grid-cols-[48px_389px_137px_137px_137px_111px] items-center  h-[72px]  ">
            <div className="id border pl-[10px] w-[48px] flex items-center border-[#0000000f] h-full" >{index+1}</div>
             ...
             <div className="stock border pl-[10px] w-[137px] flex flex-col gap-xs justify-center border-[#0000000f] h-full" >{product.quantity}</div>
             <div className="price border pl-[10px] w-[137px] flex items-center border-[#0000000f] h-full" >{product.priceAtPurchase}</div>
